...
<div class="p-8 text-lg" id="mainContent">
    <div class="max-w-prose">
        ...
        <div class="p-3 bg-slate-100/80 dark:bg-slate-900/80 rounded-lg">
            ...
            <div class="p-2 lg:p-4 text-lg bg-white dark:bg-[#002850] rounded-lg">
            ...
            <?php if ($activity->status_id == 2) : ?>
                <div>
                    <a target="_blank" rel="noopener" data-toggle="tooltip" data-placement="bottom" title="Launch this activity" href="/activities-users/launch?activity_id=<?= $activity->id ?>" class="inline-block my-2 p-3 bg-sky-700 rounded-lg text-white text-2xl hover:no-underline">
                        Launch Activity
