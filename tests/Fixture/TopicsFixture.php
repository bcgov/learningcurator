...
class TopicsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'topic_user_ibfk_1' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'topic_user_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-03-30 18:07:33',
                'user_id' => '6768cd2a-3283-4922-ab17-e16d4d2230ac',
            ],
        ];
        parent::init();
    }
