        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $activitiesTag->activity_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $activitiesTag->activity_id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $activitiesTag->activity_id], ['confirm' => __('Are you sure you want to delete # {0}?', $activitiesTag->activity_id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
