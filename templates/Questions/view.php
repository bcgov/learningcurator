...
<div class="p-8 text-lg" id="mainContent">
    <div class="max-w-prose">
        ...
        <div class="mt-4">
            <?= $this->Html->link(__('Edit Question'), ['action' => 'edit', $question->id], ['class' => 'inline-block px-3 py-1 text-white text-base bg-slate-700 hover:bg-slate-700/80 focus:bg-slate-700/80 hover:no-underline rounded-lg']) ?>
            ...
            <?= $this->Html->link(__('Add New Question'), ['action' => 'add'], ['class' => 'inline-block px-3 py-1 text-white text-base bg-slate-700 hover:bg-slate-700/80 focus:bg-slate-700/80 hover:no-underline rounded-lg']) ?>
        </div>
    </div>
</div>