            ...
            <?php foreach ($pathways as $pathway) : ?>
                <div class="mb-8">
                    ...
                    <a href="/pathways/<?= h($pathway->slug) ?>" class="hover:no-underline">
                        ...
                        <div class="pl-2 pr-3 py-2 mt-3 mb-3 bg-bluegreen text-white  hover:bg-bluegreen/80  w-full rounded-l-full flex items-center justify-between">
                            ...
                            <div class="p-3 text-lg">
                                ...
                                <div class="">
                                    <?php if (!empty($a->description)) : ?>
                                        <div class="autop"><?= $this->Text->autoParagraph(h($a->description)); ?></div>
                                ...
                                <div class="text-sm mt-2">
                                    ...
                                    <?php foreach ($a->steps as $step) : ?>
                                        <?php if (!empty($step->pathways[0]->slug)) : ?>
                                            &bull;<a href="/pathways/<?= h($step->pathways[0]->slug) ?>/s/<?= $step->id ?>/<?= $step->slug ?>" class="px-1"><?= h($step->pathways[0]->name) ?>, <?= h($step->name) ?></a>
                                        <?php endif ?>
                                    <?php endforeach ?>
