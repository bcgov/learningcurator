...
class PathwaysFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'pathway_category_ibfk_1' => ['type' => 'index', 'columns' => ['category_id'], 'length' => []],
            'pathway_ministry_ibfk_1' => ['type' => 'index', 'columns' => ['ministry_id'], 'length' => []],
            'pathway_createduser_ibfk_1' => ['type' => 'index', 'columns' => ['createdby'], 'length' => []],
            'pathway_modifieduser_ibfk_1' => ['type' => 'index', 'columns' => ['modifiedby'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'name' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
            'pathway_category_ibfk_1' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'category_id' => 1,
                'ministry_id' => 1,
                'created' => '2020-01-28 22:27:47',
                'createdby' => 1,
                'modified' => '2020-01-28 22:27:47',
                'modifiedby' => 1,
            ],
        ];
        parent::init();
