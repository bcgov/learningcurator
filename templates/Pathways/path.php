...
<li class="nav-item" role="presentation">
	<a class="nav-link" 
		...
		id="<?= $steplink['slug'] ?>-tab"
		title="<?= $steplink['objective'] ?>"
		data-toggle="tab" role="tab" aria-controls="pathway-<?= $steplink['slug'] ?>" aria-selected="">
			<?= $steplink['name'] ?>
	</a> 
</li>
<?php endforeach ?>
...
<div class="tab-content" id="allsteps">
<?php $count = 0 ?>
<?php foreach ($pathway->steps as $steps) : ?>
<?php 
$count++;
$tabclass = '';
if($count == 1) $tabclass = 'show active'; 
?>
<div class="tab-pane fade <?= $tabclass ?>" id=pathway-<?php echo slugify($steps->name) ?>" role="tabpanel" aria-labelledby="<?php echo slugify($steps->name) ?>-tab">
...
?>
<h1 class="<?= $completeclass ?>"> <!-- id="pathway-<?php echo slugify($steps->name) ?>" -->
