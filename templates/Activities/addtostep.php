...
<div class="p-8 text-lg" id="mainContent">
    ...
    <div class="max-w-prose">
        <?php if (!empty($activity)) : ?>
            ...
            <h3 class="text-xl my-3">
                Activity: <a href="/activities/view/<?= $activity[0]->id ?>"><?= $activity[0]->name ?></a>
            </h3>
    ...
    <div class="max-w-prose outline outline-1 outline-slate-500 p-6 my-3 rounded-md block">
        ...
        <form method="get" id="pathfind" action="/pathways/find" class="mb-2">
            <label for="q">Find a pathway:</label>
            <input id="q" class="form-field sm:mr-2" type="search" placeholder="Search" aria-label="Search" name="q">
    ...
    <?php else : ?>
        ...
        <div id="linkdeets">
            <div class="max-w-prose flex justify-between gap-4 border-2 p-3 rounded-md my-3">
                ...
                <div class="grow">
                    <h3 class="mb-3 text-xl font-semibold">Fetching details...</h3>
                    <div id="loading">
        ...
        <?php if ($linktoact) : ?>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#linkdeets').html('<div class="max-w-prose outline outline-1 outline-slate-500 p-6 my-3 rounded-md block"><h3 class="text-xl font-semibold mb-1">New Activity</h3><p><strong>Title:</strong> ' + deets.title + '</p><p><strong>Description:</strong> ' + descr + '</p><p class="mb-0"><strong>Hyperlink:</strong> ' + '<?= urldecode($linktoact) ?>' + '</p></div>');
                },
                statusCode: {
                    403: function() {
                        // oh no
