...
<div>People keep asking questions, and we keep providing answers.</div>
</div>
</div>
</div>
</div>
...
<?php
    echo $this->Form->control('title',['class' => 'form-control form-control-lg']);
...
?>
<?= $this->Form->button(__('Add question'),['class' => 'btn btn-success mt-3']) ?>
<?= $this->Form->end() ?>
</div>
</div>
</div>
