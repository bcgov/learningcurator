        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $categoriesTopic->category_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $categoriesTopic->category_id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $categoriesTopic->category_id], ['confirm' => __('Are you sure you want to delete # {0}?', $categoriesTopic->category_id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
