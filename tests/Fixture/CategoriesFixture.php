...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'cat_createduser_ibfk_1' => ['type' => 'index', 'columns' => ['createdby'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'cat_createduser_ibfk_1' => ['type' => 'foreign', 'columns' => ['createdby'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-03-30 18:07:29',
                'createdby' => 'e2e6c207-73de-438c-a3b1-36f4c2f25aba',
            ],
        ];
        parent::init();
    }
