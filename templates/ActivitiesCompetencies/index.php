        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $activitiesCompetency->id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $activitiesCompetency->id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $activitiesCompetency->id], ['confirm' => __('Are you sure you want to delete # {0}?', $activitiesCompetency->id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
