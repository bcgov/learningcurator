...
<h2 class="font-weight-light">Topics</h2>
<div class="p-3 rounded-lg my-3 bg-white shadow-sm">
	<h3 class="font-weight-light"><a href="/categories/view/1">Leadership</a></h3>
...
<div class="p-3 rounded-lg my-3 bg-white shadow-sm">
	<h3 class="font-weight-light"><a href="/categories/view/3">Diversity &amp; Inclusion</a></h3>
...
<div class="p-3 rounded-lg my-3 bg-white shadow-sm">
	<h3 class="font-weight-light" style="color: #666">Role Specific <small><em>coming soon</em></small></h3>
...
<iframe width="100%" 
		height="240" 
		src="https://www.youtube-nocookie.com/embed/ZOJh-tvcxvE" 
		frameborder="0" 
