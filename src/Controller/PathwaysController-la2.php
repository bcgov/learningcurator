...
class PathwaysController extends AppController
{
    ...
    public function view($id = null)
    {
        ...
        if(!empty($user)) {
            ...
            foreach($useractions as $uact) {
                array_push($useractionlist, $uact['action_id']);
            }
        }

        $pathway = $this->Pathways->get($id, [
            'contain' => ['Categories', 'Ministries', 'Competencies', 'Steps', 'Steps.Actions', 'Steps.Actions.ActionTypes', 'Steps.Actions.Users', 'Users'],
        ]);
        //
	...
	foreach($pathway->users as $pu) {
        ...
        $this->set(compact('pathway', 'usersonthispathway', 'useractionlist'));
    }
