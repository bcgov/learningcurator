...
<div class="p-8 text-lg" id="mainContent">
    ...
    <h2 class="text-2xl text-darkblue font-semibold mb-3">All Open Reports <span class="inline-block ml-2 text-sky-700 hover:underline text-base font-normal"> <a href="/reports/closed">View All Closed Reports</a></span></h2>
