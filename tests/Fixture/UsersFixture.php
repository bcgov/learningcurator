...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'idir' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'user_ministry_ibfk_1' => ['type' => 'index', 'columns' => ['ministry_id'], 'length' => []],
            'user_role_ibfk_1' => ['type' => 'index', 'columns' => ['role_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'user_ministry_ibfk_1' => ['type' => 'foreign', 'columns' => ['ministry_id'], 'references' => ['ministries', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'user_role_ibfk_1' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['roles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'idir' => 'Lorem ipsum dolor sit amet',
                'ministry_id' => 1,
                'role_id' => 1,
