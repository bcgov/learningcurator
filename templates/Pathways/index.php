...
<div class="p-3 my-3 bg-white dark:bg-slate-800 rounded-lg">
	...
	<h2 class="mb-2 text-2xl">
		<a href="/<?= h($pathway->topic->categories[0]->slug) ?>/topic/<?= h($pathway->topic->slug) ?>/pathway/<?= h($pathway->slug) ?>" class="font-weight-bold">
	...
	<a href="/<?= h($pathway->topic->categories[0]->slug) ?>/topic/<?= h($pathway->topic->slug) ?>/pathway/<?= h($pathway->slug) ?>" 
